...
class ChatService extends ChangeNotifier {
  ...
  static final Map<String, List<String>> _vaccineIdMapping = {
    ...
    'td': ['td_school'],
    ,
    'vitA': ['vitA_1', 'vitA_3', 'vitA_school'],
    'hepb0': ['hepb0'],
    'dtp': ['penta4', 'td_school'],
  };
