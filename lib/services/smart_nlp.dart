...
class SmartNLP {
  ...
  static final Map<String, List<String>> _synonyms = {
    ...
    'تطعيم': ['لقاح', 'حقنه', 'تطعيمه', 'تطعيمات', 'لقاحات', 'حقن', 'تطعم', 'تطعيمات', 'تطعيماته', 'ياخذ تطعيم', 'ياخذ حقنه', 'ياخذ لقاح', 'ياخذ التطعيم', 'زباره', 'زبارات'],
    ...
    'مرض': ['مرض', 'امراض', 'عدوى', 'инфекци', 'وباء', 'عدوه', 'عدوات', 'عدوى'],
    ...
    'فيتامين': ['فيتامين', 'vitamin', 'فيتامين ا', 'فيتامين a', 'فيتامين أ', 'كبسوله'],
  ...
  static String detectIntent(String normalized, {String? previousIntent, String? lastTopic}) {
    ...
    if (RegExp(r'طوارئ|خطير|خطر|يسكر|يعور|ما يتنفس|يتلوى|يتشنج|فقد وعي|ما يرد|اختنق|ينزف|ينкров|شاحب|يرتعش بشكل خطير|ما يقدر يتنفس')
