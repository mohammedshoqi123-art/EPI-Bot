...
class SmartNLP {
  ...
  static bool isGreeting(String text) {
    final n = normalize(text);
    return RegExp(r'^(مرحب|سلام|هلا|صباح|مساء|السلام|يا هلا|هلا وغلا|شخبارك|اخبارك|كيفك|كيف الحال|ايش الاخبار|وش الاخبار|يسعد|෴|بوت|هلو|الو| alo|hi |hello|hey |اهلا|يا مساء|يا صباح|كيف حالك|شلونك|عامل كيفك|زينك|عساك|كيف الحالك|مساء الخير|صباح النور)'
        .hasMatch(n);
  }
