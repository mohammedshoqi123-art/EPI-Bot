...
class SmartNLP {
  ...
  static final Map<String, int> _arabicNumbers = {
    ...
    'ثلاث': 3, 'ثلاثه': 3, 'تلاته': 3, 'اربع': 4, 'اربعه': 4, 'اربعة': 4,
    'خمس': 5, 'خمسه': 5, 'خمسة': 5,
    'ست': 6, 'سته': 6, 'ستة': 6, 'ستت': 6,
    'سبع': 7, 'سبعه': 7, 'سبعة': 7,
    'ثماني': 8, 'ثمانيه': 8, 'ثمانية': 8, 'ثمانت': 8,
    ...
    'ستطعش': 16, 'سته عشر': 16,
    'عشرين': 20, 'عشرون': 20,
    'واحد وعشرين': 21, 'واحد و عشرين': 21, '21': 21,
    'ثلاثين': 30, 'ثلاثون': 30,
    'اربعين': 40, 'اربعون': 40,
    'خمسين': 50, 'خمسون': 50,
    'ستين': 60, 'ستون': 60,
  ...
  static final Map<String, List<String>> _synonyms = {
    'حراره': ['سخونه', 'حمى', 'يرتفع', 'سخن', 'حمم', 'حرار', 'يسخن', 'سخنت', 'سخون', 'حرارته', 'سخونيته', 'يرتفع الحراره', 'طلعت حراره'],
    'الم': ['يالم', 'يتالم', 'يتألم', 'وجع', 'يوجع', 'يعور', 'الام', 'مؤلم', 'الامه', 'يعوره'],
    'احمرار': ['احمر', 'يحمر', 'حمره', 'احمرت', 'حمر', 'محمر'],
    'تورم': ['انتفاخ', 'ينتفخ', 'ورم', 'يتورم', 'انتفخ', 'تنفخ', 'متورم', 'منتفخ', 'تنفخت', 'انتفخت'],
    'تطعيم': ['لقاح', 'حقنه', 'تطعيمه', 'تطعيمات', 'لقاحات', 'حقن', 'تطعم', 'تطعيمات', 'تطعيماته', 'ياخذ تطعيم', 'ياخذ حقنه'],
    'طفل': ['رضيع', 'وليد', 'صغير', 'بيبي', 'ولد', 'بنت', 'عيل', 'الطفل', 'اطفال', 'ولدي', 'بنتي', 'ابني', 'طفله', 'طفلها', 'الطفله'],
    'مريض': ['مريضه', 'تعبان', 'تعبانه', 'مريض', 'مصاب', 'تعب', 'مريضين', 'مريضات', 'مريضه', 'مريضه شوي', 'موعافيه'],
    'مجاني': ['مجانا', 'بلاش', 'بدون فلوس', 'ما يكلف', 'مجان', 'بلا رسوم', 'مجاناً', 'بلا قروش', 'ما ياخذون فلوس'],
    'خطر': ['خطير', 'يخوف', 'مضر', 'ضار', 'مو امان', 'مو آمن', 'يخطّر', 'خطرر'],
    'عمر': ['سن', 'عمر', 'كبر', 'صغير', 'عمره', 'عمرها', 'سنه', 'عمر الطفل'],
    'اثار': ['اعراض', 'جانبيه', 'تأثير', 'يصير', 'يسوي', 'يحصل', 'اضرار', 'مضره', 'يصير بعده', 'وش يسوي بعد'],
    'امان': ['امان', 'مو ضار', 'ما يضر', 'مو خطر', 'آمن', 'امنه', 'مو خطر', 'امنة'],
    'مكان': ['وين', 'اين', 'مركز', 'مستشفى', 'عياده', 'محل', 'اماكن', 'وين اروح', 'اين اذهب'],
    'وقت': ['متى', 'وقت', 'ميعاد', 'موعد', 'تاريخ', 'متى ياخذ', 'متى اعطيه', 'متى اوديه'],
    'عدد': ['كم', 'عدد', 'كم مره', 'كم جرعه', 'كم حقه', 'كم عدد', 'كم حقنه'],
    'مرض': ['مرض', 'امراض', 'عدوى', 'инфекци', 'وباء', 'عدوه', 'عدوات'],
    'منع': ['مانع', 'يمنع', 'ما يقدر', 'مو راضي', 'رفض', 'مانع', 'يمنعون', 'ما يخلونه'],
    'مناسب': ['مناسب', 'زين', 'كويس', 'تمام', 'اوكي', 'ok', 'صالح', 'حلو', 'good'],
    'طوارئ': ['طوارئ', 'عاجل', 'خطير', 'مستعجل', 'حاله طوارئ', 'emergency', 'اسعاف'],
    'تبريد': ['تبريد', 'براده', 'ثلاجه', 'تخزين', 'بارد', 'بروده', 'ثلاجات'],
    'حمله': ['حمله', 'حملات', 'تطعيم وطني', 'NIDs', 'ايام التحصين', 'يوم التحصين'],
    'مدرسه': ['مدرسه', 'مدرسي', 'التحاق', 'دخول المدرسه', 'طلاب', 'المدرسه'],
    'حوامل': ['حامل', 'حوامل', 'ام', 'حامله', 'الام الحامل', 'امه حامل'],
  ...
  static String detectIntent(String normalized, {String? previousIntent, String? lastTopic}) {
    ...
    // ── فوائد ──
    if (RegExp(r'فوائد|ليش نطعم|ليش مهم|فايده|ليش لازم|وش الفايده|ليه نطعم').hasMatch(n)) return 'benefits';
